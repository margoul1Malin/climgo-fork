      ...
      <div className="bg-transparent shadow-lg">
        <div className="container mx-auto px-4">
          ...
          <div className={`fixed inset-0 z-50 md:hidden transition-all duration-300 ${
            ...
            {/* Menu Panel */}
            <div className={`absolute top-0 right-0 h-full w-full max-w-sm climBg shadow-2xl transform transition-transform duration-300 ease-in-out ${
              isMenuOpen ? 'translate-x-0' : 'translate-x-full'
                ...
                <div className="flex items-center justify-between p-6 border-b border-blue-800">
                  ...
                  <button
                    onClick={closeMenu}
                    className="p-2 rounded-full text-white hover:bg-blue-800 transition-colors"
                  >
                ...
                <nav className="flex flex-col p-6 space-y-6">
                  <Link 
                    href="/" 
                    onClick={closeMenu}
                    className="text-white hover:text-blue-200 transition-colors text-lg font-medium border-b border-blue-800 pb-3"
                  >
                    Accueil
                  </Link>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="pl-4 space-y-3">
                      <Link 
                        href="/chauffage" 
                        onClick={closeMenu}
                        className="block text-blue-200 hover:text-white transition-colors text-base"
                      >
                        • Chauffage
                      </Link>
                      <Link 
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 border-t border-blue-800">
                  <div className="flex justify-center space-x-4">
                    <Link href="https://www.facebook.com" target="_blank" rel="noopener noreferrer" className="p-2 bg-white rounded-full hover:scale-110 transition-transform">
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="#1877F2">
                        <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                      </svg>
                    </Link>
                    <Link href="https://www.instagram.com/climgo_climatisation_chauffage" target="_blank" rel="noopener noreferrer" className="p-2 bg-white rounded-full hover:scale-110 transition-transform">
                    ...
                    <Link href="https://www.linkedin.com" target="_blank" rel="noopener noreferrer" className="p-2 bg-white rounded-full hover:scale-110 transition-transform">
